...
contract ProvenanceReputation {
    ...
    mapping(bytes32 => uint256) public ipfsToEntry;
    ...
    function addEntry(string memory ipfsHash, uint256 reputation) public {
        ...
        entries.push(Entry({ipfsHash: ipfsHash, timestamp:block.timestamp, submitter:msg.sender, reputation: reputation}));
        ipfsToEntry[h] = entries.length;
